const features = [
  ...
  },
  {
    ...
    description:
      "Agreement objects have key + store abilities — they can be shared, wrapped, or embedded inside other contracts. Extract balances and objects programmatically for custom routing.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
const subFeatures = [
  ...
  },
  {
    ...
    description: "Built-in arbiter system with split resolutions, per-asset assignment, and basis-point precision.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
